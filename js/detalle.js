...
labelCategoria.innerHTML = paquetePrueba.categoria;
labelNombre.innerHTML = paquetePrueba.nombre;
labelDescripcion.innerHTML = paquetePrueba.descripcion;
labelPrecio.innerHTML = `${paquetePrueba.precio} $`;
